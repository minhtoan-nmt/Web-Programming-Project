...
function SubImage({subImage = subImage}) {
    const listImage = subImage.map(image => {
        return (
            <Image key={image.id} src={image.url} alt="Sub image for product 1" className="my-2"/>
        )
    })
    return (
...
export default function ProductDetail() {
    return (
        ...
        <div className="pt-30 px-30">
            <h1 className="mb-12 text-gray-400">Trang chủ  /  Sản phẩm  /  <span className="font-bold text-gray-600">Thông tin chi tiết</span> </h1>
            <div className="grid grid-cols-[5fr_3fr] gap-12">
                <div className="grid grid-cols-[1fr_4fr] gap-6 ">
                    ...
                    <div id="detail-col-2">
                        <Image src={gamepad1} alt="sth for you" className="h-full w-full"/>
                    </div>
                </div>
                <div id="detail-col-3">
                    <div className="mb-12">
                    ...
                    <p className="mb-4 border-b-2 border-gray-400 pb-6">{product.description}</p>
                    <p>
                        Màu: 
                        <button type="button"><Image src={green} alt="green" width={16} height={16} 
                            className="inline ml-2 mr-1"/></button>
                        <button type="button"><Image src={red} alt="red" width={16} height={16} 
                    ...
                    <div>
                        <div className="flex flex-row border border-2 mt-12">
                            ...
                            <div className="flex flex-col justify-center p-3 mx-2">
                                <h1 className="text-xl font-bold mb-1 mt-2">Giao hàng miễn phí</h1>
                                <p className="text-sm my-1 underline underline-offset-4">Cung cấp địa chỉ và thông tin để nhận hàng</p>
                            </div>
                        </div>
                        <div className="flex flex-row border-b-2 border-l-2 border-r-2">
                            ...
                            <div className="flex flex-col justify-center p-3 mx-2">
                                <h1 className="text-xl font-bold mb-1 mt-2">Chính sách đổi trả</h1>
