...
export default function Page({ params }) {
  ...
  }, [postId, newCommentAdded]); // Add newCommentAdded to dependency array

  const handleCommentSubmit = () => {
    setNewCommentAdded(prev => !prev); // Trigger comment refresh
  };
  ...
  return (
    <div className="flex flex-col max-sm:p-6 max-md:p-12 p-24">
      ...
      <CreateComment className="mx-[14%] mb-12" postId={postId} onCommentSubmit={handleCommentSubmit} /> {/* Pass the new prop */}
